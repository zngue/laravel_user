    ...
    <div class="layui-header header">
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="{{route('index')}}">
                    <span style="font-size: 22px;">{{config('zngue.user.sys_name')}}</span>
                </a>
            ...
            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                ...
                <li class="layui-nav-item">
                    <a href="{:url(config('app.default_module').'/index/index')}" target="_blank">网站首页</a>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="{:url('index/logout')}"><i class="fa fa-sign-out" aria-hidden="true"></i>退出</a>
                        </dd>
                    </dl>
                </li>
            </ul>
